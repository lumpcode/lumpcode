<!-- X Article paste guide
Title:    Codemods grew a brain. Our tooling didn't.
Subtitle: Why I’m building a git-first loop manager.

IMPORTANT: X Articles does NOT parse Markdown on paste. If you paste this
file as plain text, you will see literal ## and ** in preview.

Preferred: open 04-why-lumpcode.x.html in a browser, select the article
body (not the gray help box), copy, paste into X (rich text).

Alternates: Chrome "X Article Markdown Paste" extension, or
https://markdown2x.com/ → Copy body → paste into X.
-->

Why I’m building a git-first loop manager.
...
Repo: [github.com/lumpcode/lumpcode](https://github.com/lumpcode/lumpcode)
