...
- Large helper/command suites may colocate under `<name>/testing/` (first: `executeStepsForContextList/testing/`, CLI: `commands/start/testing/` — `general.unit.test.ts`, topic files, `testHelpers.ts`); keep `main.ts`/`index.ts` at the module root; exclude `**/helpers/**/testing/**` (core) and `**/commands/**/testing/**` (CLI) from package tsconfig emit
