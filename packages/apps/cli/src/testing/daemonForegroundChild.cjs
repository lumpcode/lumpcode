...
const daemonId = (process.env.LUMPCODE_DAEMON_ID || 'global').trim() || 'global';
const includeRaw = process.env.LUMPCODE_DAEMON_INCLUDE || '';
const excludeRaw = process.env.LUMPCODE_DAEMON_EXCLUDE || '';
